...
def main_worker(gpu, ngpus_per_node, args):
    ...
    moco_transform = moco.loader.TwoCropsTransform(transforms.Compose(augmentation))

    train_dataset = torchvision.datasets.CIFAR10(root='', train=True, download=True, transform=moco_transform)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, _) in enumerate(train_loader):
        ...
        if i % args.print_freq == 0:
            ...
            with open(f'moco_pretrain_{epoch}_{i}.txt', 'w+') as f:
                f.write(entries_str + '\n')
